...
def main():
    while True:
        ...
        # Controlar los LEDs con respecto a las temperaturas leídas
        control_leds(temp_setpoint, actual_temp)
        
        # Imprimir los valores de temperatura de consigna y de temperatura de la actual
...
def read_potentiometer():
    ...
    # Que el valor leído escale a un rango entre 0 a 30 grados Celsius
...
def read_thermistor():
    ...
    # Convertir el valor del termistorn en grados Celsius utilizando la ecuación de Steinhart-Hart
...
def control_leds(temp_setpoint, actual_temp):
    # Calcular la diferencia entre la temperatura actual y la temperatura de consigna
    ...
    if difference > 0:
        # Si la temperatura actual esta por arriba de la de consigna, que se encienda el LED azul
        blue_led.value = duty_cycle
        red_led.value = 0
    else:
        # Si la temperatura actual está por debajo de la consigna, que se encienda el LED rojo
